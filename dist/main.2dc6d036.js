...
},{"symbol-observable":"node_modules\\symbol-observable\\es\\index.js"}],"main.tsx":[function(require,module,exports) {
"use strict";
...
var reducer = function reducer(state, action) {
    ...
    switch (action.type) {
        case "add":
            return __assign({}, state, { x: state.x + action.amount });
        case "remove":
            return __assign({}, state, { x: state.x - 1 });
    }
};
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            { onClick: function onClick() {
                    return store.dispatch({ type: "add", amount: 2 });
                } },
            " add number"
        ),
        React.createElement(
            "button",
            { onClick: function onClick() {
                    return store.dispatch({ type: "remove" });
                } },
            " remove number"
        )
    );
...
var draw = function draw() {
    return react_dom_1.render(React.createElement(App, { store: store }), document.getElementById('app'));
};
draw();
store.subscribe(draw);
},{"react":"node_modules\\react\\index.js","react-dom":"node_modules\\react-dom\\index.js","redux":"node_modules\\redux\\es\\redux.js"}],"node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.2dc6d036.map